...
class PPOAgent:
    ...
    def learn(self, states, actions,  adv , discnt_rewards):
        ...
        with tf.GradientTape() as tape1, tf.GradientTape() as tape2:
            ...
            a_loss = self.actor_loss(p, actions, adv, self.old_probabilites, c_loss)
    ...
    def train(self, num_episodes):
        ...
        for episode_index in range(num_episodes):
            ...
            if episode_index == 1:
                self.old_probabilites = probs
            al,cl = self.learn(states, actions, adv, returns)
            
            if episode_index % 10000 == 0:
                self.A.save(f"A_{episode_index}.h5")
